...
public class Reg_Activity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		upstuphoto.setOnClickListener(new Button.OnClickListener(){//´´½¨¼àÌý    
            public void onClick(View v) {    
                  
            }    
  
        });    
		upusrphoto.setOnClickListener(new Button.OnClickListener(){//´´½¨¼àÌý    
            public void onClick(View v) {    
                  
            }    
  
        });   
		cfreg.setOnClickListener(new Button.OnClickListener(){//´´½¨¼àÌý    
            public void onClick(View v) {    
