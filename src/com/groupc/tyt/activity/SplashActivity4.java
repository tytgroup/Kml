...
public class SplashActivity4 extends Activity {
	...
	private String url = ConstantDef.BaseUil+"RelativeApplyService";
	@Override
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (HttpClientUtil.isjson(feedback)) {			
					 Intent intent=new Intent(SplashActivity4.this,RelativeApplyActivity.class);
				...
				if (feedback.equalsIgnoreCase("2")) {
					Toast.makeText(getApplicationContext(), "没有可以评价的买家！", Toast.LENGTH_SHORT)
							.show();
				} else {
